...
inline __attribute__((always_inline)) void pinHigh( gpio_pin_number_t pin );
inline __attribute__((always_inline)) void pinLow(  gpio_pin_number_t pin );
...
void pinInit()
{
    ...
    gpio_write(PIN_TO_NEW_VCD, false);
    gpio_write(PIN_TO_CTRL_VCD, false);
