...
output_channel = output_ch;
    ...
    for(int16_t i = 0; i < 3; i++) {
        cgra_input[0][i] =   &(input_to_CGRA[0][input_channel][0][i]);
        cgra_input[1][i] =   &(input_to_CGRA[0][input_channel][1][i]);
        cgra_input[2][i] =   &(input_to_CGRA[0][input_channel][2][i]);
    ...
    for(int16_t i = 3; i < 6; i++){
        cgra_input[0][i] = filter_to_CGRA[output_channel][input_channel][0][i-3];
        cgra_input[1][i] = filter_to_CGRA[output_channel][input_channel][1][i-3];
        cgra_input[2][i] = filter_to_CGRA[output_channel][input_channel][2][i-3];
    }
