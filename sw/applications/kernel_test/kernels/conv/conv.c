...
void config()
{
    ...
    for(int16_t i = 0; i < (IN_VAR_DEPTH); i++) {
        cgra_input[0][i] = In_Img[3*i];
        cgra_input[1][i] = In_Img[3*i + 1];
        cgra_input[2][i] = In_Img[3*i + 2];
    }
